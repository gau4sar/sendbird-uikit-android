...
public class OtherAudioFileMessageView extends GroupChannelMessageView {
    private SbViewOtherFileAudioMessageComponentBinding binding;

    @Override
    public SbViewOtherFileAudioMessageComponentBinding getBinding() {
        return binding;
    }
    ...
    public OtherAudioFileMessageView(Context context) {
        this(context, null);
    }

    public OtherAudioFileMessageView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.sb_message_file_style);
    }

    public OtherAudioFileMessageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            this.binding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.sb_view_other_file_audio_message_component, this, true);
            ...
            binding.audioPlayerView.setupUi(false);
        } finally {
            a.recycle();
        }
    }
